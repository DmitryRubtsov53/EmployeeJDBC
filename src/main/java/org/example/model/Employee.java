...
public class Employee {
    ...
    public boolean equals(Object o) {
        ...
        return id == employee.id && city_id == employee.city_id && Objects.equals(first_name, employee.first_name)
                && Objects.equals(last_name, employee.last_name) && Objects.equals(gender, employee.gender);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, first_name, last_name, gender, city_id);
    }
